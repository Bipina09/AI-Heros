...
| 4 | 🔬 AI Lab | **Match** AI outputs to prompt quality | Understand how prompt quality affects results |
...
**Change certificate criteria:** In `showCertificate()`, adjust the `pct` thresholds.
